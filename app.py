...
# -----------------------------
# Google Drive default CSV
# -----------------------------
GDRIVE_FILE_ID = "1bomTjTtvi22fyQWBARn3CcR-M9387dy2"
GDRIVE_URL = f"https://drive.google.com/uc?id={GDRIVE_FILE_ID}"

# -----------------------------
# Sidebar: Upload CSV (optional)
# -----------------------------
st.sidebar.header("Upload Flight Data (optional)")
uploaded_file = st.sidebar.file_uploader("Upload CSV file", type=["csv"])

# Use uploaded file if available, else Google Drive CSV
file_to_load = uploaded_file if uploaded_file else GDRIVE_URL
...
if st.session_state.analyzer is None:
    analyzer = FlightAIAnalyzer()
    success = analyzer.load_and_preprocess_data(file_to_load)
    if not success:
